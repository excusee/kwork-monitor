...
объявлений для маркетплейсов и досок объявлений (Wildberries, Ozon, Авито \
и подобные площадки, под любым названием и с любыми опечатками) — включая \
инфографику, баннеры, оформление, а также AI-генерацию изображений/визуалов \
для этой же цели?

Это НЕ относится: копирайт/наполнение текстом, SEO/продвижение, разработка \
сайтов, дизайн НЕ для товаров/маркетплейсов (логотипы кафе, веб-дизайн и т.п.), \
видеомонтаж и прочее не по теме.
